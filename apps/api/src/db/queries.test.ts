...
describe("db/queries", () => {
  it("aggregates earning hours from overtime time entries only", async () => {
    ...
    db.insert(schema.timeEntries).values([
      { id: 10, issueId: 1, userId: 7, hours: 3, activityId: 8, activityName: "Nadgodziny", spentOn: "2026-01-05", createdOn: "x", updatedOn: "x" },
      { id: 11, issueId: 1, userId: 7, hours: 5, activityId: 99, activityName: "Other", spentOn: "2026-01-06", createdOn: "x", updatedOn: "x" },
      { id: 12, issueId: 2, userId: 7, hours: 4, activityId: 99, activityName: "Other", spentOn: "2026-02-05", createdOn: "x", updatedOn: "x" },
    ]).run();
