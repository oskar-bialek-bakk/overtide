...
function seed() {
  ...
  db.insert(schema.timeEntries).values([
    { id: 1, issueId: 1, userId: 10, hours: 8, activityId: 8, activityName: "Nadgodziny", spentOn: "2026-01-01", comments: null, createdOn: "x", updatedOn: "x" },
    { id: 2, issueId: 2, userId: 10, hours: 12, activityId: 9, activityName: "Odbiór", spentOn: "2026-01-10", comments: null, createdOn: "x", updatedOn: "x" },
  ]).run();
  return db;
}
